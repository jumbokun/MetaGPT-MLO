...
class DevOpsEngineer(Role):
    ...
    profile: str = "Manages CI/CD pipelines, automates deployments, and monitors production environments for stability and performance."
    scrum_profile: str = "Developper"
    MLOps_profile: str = "DevOps engineer"
    auto_run: bool = True
    use_plan: bool = True
