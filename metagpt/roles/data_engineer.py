...
class DataEngineer(Role):
    ...
    profile: str = "Builds and optimizes data pipelines, ensures data flow and quality, and collaborates closely with Data Scientists for seamless data integration."
    scrum_profile: str = "Developper"
    MLOps_profile: str = "Data Engineer"
    auto_run: bool = True
    use_plan: bool = True
