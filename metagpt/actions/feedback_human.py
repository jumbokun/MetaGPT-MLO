...
class DataScientist(Role):
    ...
    profile: str = "Applies data-driven approaches to solve business problems, focuses on model performance, and ensures data quality."
    scrum_profile: str = "Developper"
    MLOps_profile: str = "Data Scientist"
    auto_run: bool = True
    use_plan: bool = True
    ...
    async def _act(self) -> Message:
        ...
        if self.rc.todo == ProvideFeedback:
            ...
            rsp = await self.rc.todo.run(context=context, profile=self.profile, role=self.MLOps_profile)
            print(rsp)
